...
import {
    ...
    ExternalLink, HardDrive, Layers, Dna, Bell, FolderKanban, Gauge,
} from "lucide-react";
...
export function Sidebar() {
    ...
    // Load persisted group state on mount
    useEffect(() => {
            ...
            <div className={`p-4 flex items-center ${isCollapsed ? "justify-center" : "justify-between"}`}>
                {isCollapsed ? (
                    ...
                    >
                        ...
                        <img src="/sutra-logo.svg" alt="Sutra" className="w-8 h-8" />
                    </button>
                ) : (
                    <>
                        <div className="flex items-center gap-2 min-w-0">
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img src="/sutra-logo.svg" alt="Sutra" className="w-9 h-9 flex-shrink-0" />
                            <span className="text-lg font-black text-stone-800 tracking-widest lowercase">sutra</span>
                        </div>
                        <button
                                    ...
                                    {isEditing ? (
                                        ...
                                        <>
                                            ...
                                            <button
                                                ...
                                                className="opacity-0 group-hover/header:opacity-100 p-0.5 rounded text-stone-300 hover:text-stone-500 transition-all flex-shrink-0"
