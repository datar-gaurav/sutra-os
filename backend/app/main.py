...
from app.api.routes import smart_organizer as smart_organizer_routes
...
app.include_router(smart_organizer_routes.router, prefix="/api", dependencies=_auth_dep)
