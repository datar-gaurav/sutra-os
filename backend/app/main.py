...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        async with async_session_factory() as db:
            ...
            evolve_tools = [
                "evolve_get_platform_stats", "evolve_get_error_patterns", "evolve_submit_suggestion",
            ...
            evolve_prompt = (
                ...
                "2. Use evolve_get_error_patterns to find recurring issues\n"
                "3. Search your memory for past analyses to track trends\n"
                "4. Generate specific, actionable suggestions using evolve_submit_suggestion\n"
                "5. Save analysis results to memory for future reference\n\n"
                "CRITICAL RULES:\n"
                "- NEVER execute changes directly. All suggestions go through human approval.\n"
                "- Be specific with evidence. Include numbers, agent names, error messages.\n"
