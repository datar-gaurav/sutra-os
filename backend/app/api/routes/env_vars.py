...
ENV_VAR_SCHEMA: list[dict[str, Any]] = [
    ...
    {
        "key": "NVIDIA_NIM_API_KEY", "group": "LLM API Keys",
        "label": "NVIDIA NIM API Key", "is_secret": True,
        "description": "For NVIDIA NIM hosted models (Llama, Mistral, etc. via integrate.api.nvidia.com)",
        "placeholder": "nvapi-...",
    },
